...
fname = sprintf('figures/fdtd1d_run-%d_profile-%d.pdf', profile);
...
fname = sprintf('figures/fdtd1d_run-%d_profile-%d_vs_x_it-%d.pdf', run, profile, iter);
print(fname, '-dpdf', '-bestfit');
...
figure(3);clf;
    ...
    xlabel('i_x');
    fdtd1d_annotate;
    set(gca,'xlim', [248, 260])
    set(gca,'ylim', [-0.2, 1.6])
    grid(gca, 'minor')
    fname = sprintf('figures/fdtd1d_run-%d_profile-%d_vs_x_it-%d-zoom.pdf', run, profile, iter);
    print(fname, '-dpdf', '-bestfit');
